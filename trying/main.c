...
//---------------------------------------------------------//
    ...
    printf("8. The fourth value in the array using pointer arithmetic: %d \n\n", *(var_array+3)); //this is the value of the memory location 2 spaces dowb from the original memory location
